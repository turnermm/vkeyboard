...
//  this.VKI_kts = this.VKI_kt = "US International";  // Default keyboard layout 
 // this.VKI_kts = this.VKI_kt = '\u0395\u03bb\u03bb\u03b7\u03bd\u03b9\u03ba\u03ac';  
//  this.VKI_kts = this.VKI_kt = this.getVKIKBLayOut();
  ...
  this.VKI_imageURI = DOKU_BASE+'lib/plugins/vkeyboard/images/keyboard.png';  // If empty string, use imageless mode
  ...
  this.VKI_numpad = [
   ...
   this.getVKIKBLayOut = function() {
    if(!window.VKI_KBLAYOUT)return "US International";
     for(var i in this.VKI_layout) {
         var regex = new RegExp(VKI_KBLAYOUT,"i");
         if(this.VKI_layout[i].name.match(regex)) { 
              return[i];
         }
     }
      ...
      var th = document.createElement('th');
        ...
        var kbSelect = document.createElement('div');
          ...
          VKI_addListener(kbSelect, 'click', function() {
            ...
            kbSelect.appendChild(document.createTextNode(this.VKI_isIE ? " \u2193" : " \u25be"));
        ...
        if (this.VKI_sizeAdj) {
          var small = document.createElement('small');
            ...
            VKI_mouseEvents(small);
              small.appendChild(document.createTextNode(this.VKI_isIE ? "\u2193" : "\u21d3"));
          ...
          var big = document.createElement('big');
            ...
            VKI_mouseEvents(big);
              big.appendChild(document.createTextNode(this.VKI_isIE ? "\u2191" : "\u21d1"));
            th.appendChild(big);
        }
  ...
  if(this.VKI_isMoz) {
   /**
     *  @auth: http://www.scottklarr.com/topic/425/  
   */ 
        this.textarea = document.getElementById('wiki__text');
        this.VKI_insert = function(text) {
        var scrollPos = this.textarea.scrollTop;
        var strPos = 0;
        var br = ((this.textarea.selectionStart || this.textarea.selectionStart == '0') ? 
        ...
        else if (br == "ff") strPos = this.textarea.selectionStart;

        var front = (this.textarea.value).substring(0,strPos);  
        var back = (this.textarea.value).substring(strPos,this.textarea.value.length); 
        this.textarea.value=front+text+back;
        ...
        if (br == "ie") { 
            ...
            this.textarea.selectionStart = strPos;
            this.textarea.selectionEnd = strPos;
            this.textarea.focus();
        }
 ...
 else this.VKI_insert = function(text) {
